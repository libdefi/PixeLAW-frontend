...
- Everything below should happen in `/contracts`
  - Start Katana: `katana --allow-zero-max-fee`
  - Deploy contracts: `scarb run deploy`
  - Start Torii: `torii --manifest target/dev/manifest.json`
